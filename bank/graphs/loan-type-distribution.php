...
// Get loan counts by type for bank loans only
$query = "SELECT 
            ...
            <div class="card-body py-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-0">Bank Loan Types</h6>
        ...
        <div class="card bg-light mb-3">
            <div class="card-body py-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-0">Bank Applications</h6>
        ...
        <div class="card bg-light mb-3">
            <div class="card-body py-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-0">Bank Approval Rate</h6>
...
var optionsPie = {
    ...
    title: {
        text: 'Bank Loan Type Distribution',
        align: 'center',
        style: {
            fontSize: '16px',
            fontWeight: 'bold'
...
var optionsAmount = {
    ...
    title: {
        text: 'Bank Loan Amounts by Type',
        align: 'center',
        style: {
            fontSize: '16px',
            fontWeight: 'bold'
