        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="modal fade" id="processPaymentModal" tabindex="-1"
                    aria-labelledby="processPaymentModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-light">
                                <h5 class="modal-title" id="processPaymentModalLabel">
                                    <i class="fa-solid fa-hand-holding-dollar me-2" style="color: #6AA32D;"></i>
                            ...
                            <div class="modal-body">
                                <form id="paymentForm">
                                    <input type="hidden" id="paymentProduceId">
                                    <input type="hidden" id="paymentFarmerId">

                                    <div class="row mb-3 g-3">
                                        <div class="col-md-6">
                                            <div class="p-3 border rounded bg-light">
                                                <label class="form-label text-muted mb-1">
                                                    <i class="fa-solid fa-user me-1"></i> Farmer Name
                                                </label>
                                                <p class="form-control-plaintext fs-5 fw-medium mb-0" id="farmerName">
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="p-3 border rounded bg-light">
                                                <label class="form-label text-muted mb-1">
                                                    <i class="fa-solid fa-receipt me-1"></i> Produce Reference
                                                </label>
                                                <p class="form-control-plaintext fs-5 fw-medium mb-0"
                                                    id="produceReference"></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 g-3">
                                        <div class="col-md-6">
                                            <div class="p-3 border rounded" style="background-color: #f0f7ea;">
                                                <label class="form-label text-muted mb-1">
                                                    <i class="fa-solid fa-tag me-1"></i> Total Sale Value
                                                </label>
                                                <p class="form-control-plaintext fs-5 fw-medium mb-0"
                                                    id="totalSaleValue" style="color: #6AA32D;"></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="p-3 border rounded" style="background-color: #f0f7ea;">
                                                <label class="form-label text-muted mb-1">
                                                    <i class="fa-solid fa-building-columns me-1"></i> SACCO Commission
                                                    (10%)
                                                </label>
                                                <p class="form-control-plaintext fs-5 fw-medium mb-0"
                                                    id="saccoCommission" style="color: #6AA32D;"></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        <div class="p-3 border rounded" style="background-color: #f0f7ea;">
                                            <label class="form-label text-muted mb-1">
                                                <i class="fa-solid fa-money-bill-wave me-1"></i> Farmer Payment Amount
                                            </label>
                                            <p class="form-control-plaintext fs-5 fw-medium mb-0"
                                                id="farmerPaymentAmount" style="color: #6AA32D;"></p>
                                        </div>
                                    </div>

                                    <div class="row mb-4" id="loanSection">
                                        <div class="col-12">
                                            <div class="card border">
                                                <div class="card-header bg-light">
                                                    <h6 class="mb-0">
                                                        <i class="fa-solid fa-credit-card me-1"></i> Outstanding Loans
                                                    </h6>
                                                </div>
                                                        ...
                                                        <table class="table table-striped table-hover mb-0">
                                                            <thead>
                                                                <tr class="table-light">
                                                                    <th class="px-3">Loan Reference</th>
                                                                    <th class="px-3">Remaining Balance</th>
                                                                    <th class="px-3">Repayment Amount</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="loanTableBody">
                                                                <!-- Loans will be loaded here -->
                                                            </tbody>
                                                            <tfoot id="loanTableFooter" class="table-secondary">
                                                                <tr>
                                                                    <th class="px-3">Total</th>
                                                                    <th class="px-3" id="totalRemainingBalance"></th>
                                                                    <th class="px-3" id="totalRepaymentAmount"></th>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
                                                    </div>
                                    ...
                                    <div class="mb-4">
                                        <div class="p-3 border rounded" style="background-color: #e0efd4;">
                                            <label class="form-label text-muted mb-1">
                                                <i class="fa-solid fa-hand-holding-dollar me-1"></i> Final Payment to
                                                Farmer
                                            </label>
                                            <p class="form-control-plaintext fs-4 fw-bold mb-0" id="finalPaymentAmount"
                                                style="color: #6AA32D;"></p>
                                        </div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="paymentNotes" class="form-label">
                                            <i class="fa-solid fa-note-sticky me-1"></i> Payment Notes
                                        </label>
                            ...
                            <div class="modal-footer bg-light">
                                ...
                                <button type="button" class="btn btn-primary"
                                    style="background-color: #6AA32D; border-color: #6AA32D;"
                                    onclick="processPayment()">
                                    <i class="fa-solid fa-check me-1"></i> Process Payment
                                </button>
                            </div>
                        </div>
                    </div>
