        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Bank Transaction Report</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                <div class="card-title">Generate Bank Transaction Report</div>
                            </div>
                            <div class="card-body">
                                <form id="bank-transaction-report-form">
                                    <div class="row mb-4">
                                        <div class="col-md-6">
        ...
        $(document).ready(function() {
            ...
            $('#viewReport').click(function() {
                ...
                window.location.href =
                    `http://localhost/dfcs/bank/reports/transactions/view?start_date=${startDate}&end_date=${endDate}`;
            });
            ...
            $('#downloadPDF').click(function() {
                ...
                toastr.info('Preparing bank transaction report for download...', 'Please wait', {
                    "positionClass": "toast-top-right",
                    "progressBar": true,
                    "timeOut": 0,
                    "extendedTimeOut": 0,
                ...
                $.ajax({
                    url: "http://localhost/dfcs/ajax/bank-controller/generate-transactions-report-pdf.php",
                    type: "POST",
                    data: {
                    ...
                    success: function(response, status, xhr) {
                        ...
                        try {
                            ...
                            let filename =
                                `Bank_Transaction_Report_${startDate}_to_${endDate}.pdf`;
                            ...
                            toastr.success(
                                'Bank transaction report downloaded successfully',
                                'Success', {
                                    "positionClass": "toast-top-right",
                                    "progressBar": true,
                                    "timeOut": 3000,
                            ...
                            try {
                                ...
                                reader.onload = function() {
                                    ...
                                    toastr.error(errorJson.error ||
                                        'Failed to generate bank transaction report',
                                        'Error', {
                                            "positionClass": "toast-top-right",
                                            "progressBar": true,
                                            "timeOut": 5000
                    ...
                    error: function(xhr, status, error) {
                        toastr.clear();
                        toastr.error(
                            'Failed to generate bank transaction report. Please try again.',
                            'Error', {
                                "positionClass": "toast-top-right",
                                "progressBar": true,
                                "timeOut": 5000
                            });
                        console.error('Error generating Bank Transaction PDF:', error);
                    }
                });
            });
        });
