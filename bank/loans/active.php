...
<body>
                                ...
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-white mb-0">Pending Bank Applications</p>
                                                <?php
                                    $query = "SELECT COUNT(*) as count 
                                              FROM loan_applications 
                                              WHERE status = 'under_review' AND provider_type = 'bank'";
                                    $result = $app->select_one($query);
                                    $pending_bank_loans = ($result) ? $result->count : 0; 
                                  ?>
                                                <h4 style="color:wheat;" class="fw-semibold mt-1">
                                                    <?php echo $pending_bank_loans ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Approved Bank Loans
                                                </p>
                                                <?php 
                                   $query = "SELECT COUNT(*) as count 
                                             FROM loan_applications 
                                             WHERE status = 'approved' AND provider_type = 'bank'";
                                   $result = $app->select_one($query);
                                   $approved_bank_loans = ($result) ? $result->count : 0;
                                 ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php echo $approved_bank_loans ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                  ...
                                  $result = $app->select_one($query); 
                                  $active_bank_loans = ($result) ? $result->count : 0;
                                ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php echo $active_bank_loans ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Total Bank Approved
                                                </p>
                                                <?php
                                   ...
                                   $result = $app->select_one($query);
                                   $total_bank_approved = ($result) ? number_format($result->total_amount, 2) : 0;
                                 ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    KES <?php echo $total_bank_approved ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#FF5733;">Total Bank Amount Owed
                                                </p>
                                                <?php
                                       $query = "SELECT COALESCE(SUM(al.remaining_balance), 0) as total_owed
                                                 ...
                                                 WHERE al.status = 'active' AND la.provider_type = 'bank'";
                                       $result = $app->select_one($query);
                                       $total_bank_owed = ($result) ? number_format($result->total_owed, 2) : 0;
                                     ?>
                                                <h4 class="fw-semibold mt-1" style="color:#FF5733;">
                                                    KES <?php echo $total_bank_owed ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#00B74A;">Total Bank Amount
                                                    Repaid</p>
                                                <?php  
                                                    $query = "SELECT COALESCE(SUM(al.approved_amount - al.remaining_balance), 0) as total_repaid
                                                              FROM approved_loans al
                                                              JOIN loan_applications la ON al.loan_application_id = la.id
                                                              WHERE al.status IN ('active', 'completed') AND la.provider_type = 'bank'";
                                                    $result = $app->select_one($query);
                                                    $total_bank_repaid = ($result) ? number_format($result->total_repaid, 2) : 0; 
                                                  ?>
                                                <h4 class="fw-semibold mt-1" style="color:#00B74A;">
                                                    KES <?php echo $total_bank_repaid ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
    ...
    function displayActiveLoans() {
        ...
        $.ajax({
            url: "http://localhost/dfcs/ajax/loan-controller/display-bank-active-loans.php",
            type: 'POST',
            data: {
