...
<body>
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                ...
                                                <?php
                                   $query = "SELECT COUNT(*) as count FROM loan_applications WHERE provider_type = 'bank'";
                                   $result = $app->select_one($query);
                                   $total_bank_loans = ($result) ? $result->count : 0;
                                ?>
                                                <h4 style="color:wheat;" class="fw-semibold mt-1">
                                                    <?php echo $total_bank_loans ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    $approval_rate = ($total_bank_loans > 0) ? round(($approved_bank_loans / $total_bank_loans) * 100, 1) : 0;
                                ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php echo $approved_bank_loans ?> <small
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Rejected Bank Loans
                                                </p>
                                                <?php
                                  $query = "SELECT COUNT(*) as count FROM loan_applications 
                                            WHERE status = 'rejected' AND provider_type = 'bank'";
                                  $result = $app->select_one($query);
                                  $rejected_bank_loans = ($result) ? $result->count : 0;
                                  $rejection_rate = ($total_bank_loans > 0) ? round(($rejected_bank_loans / $total_bank_loans) * 100, 1) : 0;
                                ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php echo $rejected_bank_loans ?> <small
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Total Bank Disbursed
                                                </p>
                                                <?php
                                     ...
                                     $result = $app->select_one($query);
                                     $total_bank_amount = ($result) ? number_format($result->total_amount, 2) : 0;
                                ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    KES <?php echo $total_bank_amount ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
    ...
    function displayAllLoanApplications() {
        ...
        $.ajax({
            url: "http://localhost/dfcs/ajax/loan-controller/display-all-bank-loans.php",
            type: 'POST',
            data: {
