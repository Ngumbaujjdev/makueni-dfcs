...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Input Credit Applications Report</h1>
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Agrovet</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Applications Report</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                <div class="card-title">Generate Input Credit Applications Report</div>
                            </div>
                            <div class="card-body">
                                <form id="application-report-form">
                                    <div class="row mb-4">
                                        <div class="col-md-6">
    ...
    $(document).ready(function() {
        ...
        $('#downloadPDF').click(function() {
            ...
            toastr.info('Preparing applications report for download...', 'Please wait', {
                "positionClass": "toast-top-right",
                "progressBar": true,
                "timeOut": 0,
                "extendedTimeOut": 0,
            ...
            $.ajax({
                url: "http://localhost/dfcs/ajax/agrovet-controller/generate-applications-report-pdf.php",
                type: "POST",
                data: {
                ...
                success: function(response, status, xhr) {
                    ...
                    try {
                        ...
                        let filename =
                            `Input_Credit_Applications_Report_${startDate}_to_${endDate}.pdf`;
