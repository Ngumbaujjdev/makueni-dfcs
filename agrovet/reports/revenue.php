        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Commission & Revenue Report</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                <div class="card-title">Generate Commission & Revenue Report</div>
                            </div>
                            <div class="card-body">
                                <form id="revenue-report-form">
                                    <div class="row mb-4">
                                        <div class="col-md-6">
    ...
    $(document).ready(function() {
        ...
        $('#viewReport').click(function() {
            ...
            window.location.href =
                `http://localhost/dfcs/agrovet/reports/revenue/view?start_date=${startDate}&end_date=${endDate}`;
        });
        ...
        $('#downloadPDF').click(function() {
            ...
            toastr.info('Preparing revenue report for download...', 'Please wait', {
                "positionClass": "toast-top-right",
                "progressBar": true,
                "timeOut": 0,
                "extendedTimeOut": 0,
            ...
            $.ajax({
                url: "http://localhost/dfcs/ajax/agrovet-controller/generate-revenue-report-pdf.php",
                type: "POST",
                data: {
                ...
                success: function(response, status, xhr) {
                    ...
                    try {
                        ...
                        let filename =
                            `Commission_Revenue_Report_${startDate}_to_${endDate}.pdf`;
