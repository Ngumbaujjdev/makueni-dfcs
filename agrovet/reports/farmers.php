...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Farmer Input Credit Analysis Report</h1>
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Reports</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Farmer Credit Analysis</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                <div class="card-title">Generate Farmer Input Credit Analysis Report</div>
                                <div class="card-subtitle text-muted">
                                    Comprehensive analysis of all farmers' input credit performance across the system
                                </div>
                            </div>
                            <div class="card-body">
                                <form id="farmer-credit-analysis-form">
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <label for="start_date" class="form-label fw-semibold">Start Date</label>
                                            <input type="date" class="form-control" id="start_date" name="start_date"
                                                required>
                                            <div class="form-text">Credit applications from this date onwards</div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="end_date" class="form-label fw-semibold">End Date</label>
                                            <input type="date" class="form-control" id="end_date" name="end_date"
                                                required>
                                            <div class="form-text">Credit applications up to this date</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="alert alert-info mb-4">
                                        <h6 class="alert-heading mb-2">
                                            <i class="ri-information-line me-1"></i>Report Overview
                                        </h6>
                                        <p class="mb-1">This report provides system-wide analysis of farmer input credit
                                            performance including:</p>
                                        <ul class="mb-0 ps-3">
                                            <li>Credit portfolio summary across all farmers</li>
                                            <li>Farmer performance distribution and segmentation</li>
                                            <li>System-wide input demand and repayment patterns</li>
                                            <li>Risk assessment and strategic recommendations</li>
                                        </ul>
                                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#downloadPDF').click(function() {
            ...
            toastr.info('Preparing farmer input credit analysis report for download...',
                'Please wait', {
                    "positionClass": "toast-top-right",
                    "progressBar": true,
                    "timeOut": 0,
            ...
            $.ajax({
                url: "http://localhost/dfcs/ajax/agrovet-controller/generate-farmer-credit-analysis-pdf.php",
                type: "POST",
                data: {
                ...
                success: function(response, status, xhr) {
                    ...
                    try {
                        ...
                        let filename =
                            `Farmer_Credit_Analysis_Report_${startDate}_to_${endDate}.pdf`;
                        ...
                        toastr.success(
                            'Farmer credit analysis report downloaded successfully',
                            'Success', {
                                "positionClass": "toast-top-right",
                                "progressBar": true,
                                "timeOut": 3000,
                        ...
                        try {
                            ...
                            reader.onload = function() {
                                ...
                                toastr.error(errorJson.error ||
                                    'Failed to generate farmer credit analysis report',
                                    'Error', {
                                        "positionClass": "toast-top-right",
                                        "progressBar": true,
                                        "timeOut": 5000
                ...
                error: function(xhr, status, error) {
                    toastr.clear();
                    toastr.error(
                        'Failed to generate farmer credit analysis report. Please try again.',
                        'Error', {
                            "positionClass": "toast-top-right",
                            "progressBar": true,
                            "timeOut": 5000
