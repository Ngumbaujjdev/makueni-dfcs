...
<!-- Mirrored from spruko.com/demo/blazor/ynex/ynex/dist/html/http://localhost/dfcs/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 16:04:17 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="http://localhost/dfcs/assets/img/favicon.ico" type="image/x-icon" />
                ...
                <div class="header-content-left">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="http://localhost/dfcs/" class="header-logo">
                                <img src="http://localhost/dfcs/assets/images/brand-logos/desktop-logo.png"
                                    alt="logo" class="desktop-logo" />
                                <img src="http://localhost/dfcs/assets/images/brand-logos/toggle-logo.png"
                                    alt="logo" class="toggle-logo" />
                                <img src="vassets/images/brand-logos/desktop-dark.png" alt="logo"
                                    class="desktop-dark" />
                                <img src="http://localhost/dfcs/assets/images/brand-logos/toggle-dark.png"
                                    alt="logo" class="toggle-dark" />
                                <img src="http://localhost/dfcs/assets/images/brand-logos/desktop-white.png"
                                    alt="logo" class="desktop-white" />
                                <img src="http://localhost/dfcs/assets/images/brand-logos/toggle-white.png"
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element country-selector">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside"
                            ...
                            <img src="http://localhost/dfcs/assets/images/flags/us_flag.jpg" alt="img"
                        ...
                        <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="http://localhost/dfcs/assets/images/flags/us_flag.jpg"
                                            alt="img" />
                                    </span>
                                    English
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="http://localhost/dfcs/assets/images/flags/spain_flag.jpg"
                                            alt="img" />
                                    </span>
                                    Spanish
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="http://localhost/dfcs/assets/images/flags/french_flag.jpg"
                                            alt="img" />
                                    </span>
                                    French
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="http://localhost/dfcs/assets/images/flags/germany_flag.jpg"
                                            alt="img" />
                                    </span>
                                    German
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="http://localhost/dfcs/assets/images/flags/italy_flag.jpg"
                                            alt="img" />
                                    </span>
                                    Italian
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="http://localhost/dfcs/assets/images/flags/russia_flag.jpg"
                                            alt="img" />
                                    </span>
                                    Russian
                                </a>
                    ...
                    <div class="header-element cart-dropdown">
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                            ...
                            <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="http://localhost/dfcs/assets/images/ecommerce/jpg/1.jpg"
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="http://localhost/dfcs/assets/images/ecommerce/jpg/3.jpg"
                                            alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3" />
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start justify-content-between mb-0">
                                                <div class="mb-0 fs-13 text-dark fw-semibold">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="http://localhost/dfcs/assets/images/ecommerce/jpg/5.jpg"
                                            alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3" />
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start justify-content-between mb-0">
                                                <div class="mb-0 fs-13 text-dark fw-semibold">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="http://localhost/dfcs/assets/images/ecommerce/jpg/4.jpg"
                                            alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3" />
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start justify-content-between mb-0">
                                                <div class="mb-0 fs-13 text-dark fw-semibold">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="http://localhost/dfcs/assets/images/ecommerce/jpg/6.jpg"
                                            alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3" />
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start justify-content-between mb-0">
                                                <div class="mb-0 fs-13 text-dark fw-semibold">
                            ...
                            <div class="p-3 empty-header-item border-top">
                                <div class="d-grid">
                                    <a href="http://localhost/dfcs/my-payment/payment" class="btn btn-primary">Proceed
                                        to checkout</a>
                                </div>
                            </div>
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="http://localhost/dfcs/" class="side-menu__item">CRM</a>
                                </li>
                                <li class="slide">
...
<!-- Mirrored from spruko.com/demo/blazor/ynex/ynex/dist/html/http://localhost/dfcs/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 16:06:11 GMT -->
