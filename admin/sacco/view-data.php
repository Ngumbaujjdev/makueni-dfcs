...
<body>
                                ...
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-white mb-0">Total SACCO Staff</p>
                                                <?php
                                                    $query = "SELECT COUNT(*) as count FROM sacco_staff";
    ...
    function displayStaff() {
        ...
        $.ajax({
            url: "http://localhost/dfcs/ajax/sacco-controller/display-staff.php",
            type: 'POST',
            data: {
    ...
    function deleteStaff(deleteId) {
        if (confirm("Are you sure you want to delete this staff member?")) {
            $.ajax({
                url: "http://localhost/dfcs/ajax/sacco-controller/delete-staff.php",
                type: "POST",
                data: {
                    deletesend: deleteId
                },
    ...
    function editStaff(staffId) {
        window.location.href = 'http://localhost/dfcs/admin/sacco/update-data?id=' + staffId;
    }
    </script>
