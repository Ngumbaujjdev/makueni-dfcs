...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div>
                        ...
                        <?php endif; ?>
                        <span class="fs-semibold text-muted pt-5">Agrovet Management Dashboard Staff</span>
                    </div>
                </div>
                <div class="row mt-2">
                    <!-- Total Staff -->
                                ...
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-white mb-0">Total Staff</p>
                                                <?php
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Active Staff</p>
                                                <?php
                                                    $query = "SELECT COUNT(*) as count FROM agrovet_staff WHERE is_active = 1";
                                                    $result = $app->select_one($query);
    ...
    function displayStaff() {
        ...
        $.ajax({
            url: "http://localhost/dfcs/ajax/agrovet-controller/display-staff.php",
            type: 'POST',
            data: {
                displayStaff: displayStaff,
            },
            success: function(data, status) {
                $('#displayStaff').html(data);
            },
        });
    }
    ...
    function deleteStaff(deleteId) {
        if (confirm("Are you sure you want to delete this staff member?")) {
            $.ajax({
                url: "http://localhost/dfcs/ajax/agrovet-controller/delete-staff.php",
                type: "POST",
                data: {
                    deletesend: deleteId
                },
    ...
    // this function will redirect the user to the update page with the staff id
    function editStaff(staffId) {
        window.location.href = 'http://localhost/dfcs/admin/agrovet-staff/update-data?id=' + staffId;
    }
    </script>
