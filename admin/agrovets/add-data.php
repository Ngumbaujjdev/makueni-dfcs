...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Add Agrovet</h1>
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Agrovets</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Add Agrovet</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                <div class="card-title">Add New Agrovet</div>
                            </div>
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" class="form-control" id="agrovet-name"
                                            placeholder="Enter agrovet name" required>
                                    </div>
                                    <div class="col-xl-6">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <select class="form-control" id="type-id" required>
                                            <?php
                                            $app = new App;
                                            $query = "SELECT * FROM agrovet_types";
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <textarea class="form-control" id="address" placeholder="Enter full address"
                                            required></textarea>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end mt-4">
                                    <button class="btn text-white" onclick="submitAgrovet()"
    ...
    <script>
    // new agrovet form submission
    function submitAgrovet() {
        // Get form values
        const name = $("#agrovet-name").val();
        ...
        if (!name || !licenseNumber || !typeId || !location || !phone || !address) {
        ...
        $.ajax({
            url: 'http://localhost/dfcs/ajax/agrovet-controller/add-agrovets.php',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
            success: function(response) {
                try {
                    ...
                    if (data.success) {
                        ...
                        setTimeout(() => {
                            window.location.href = 'http://localhost/dfcs/admin/agrovets/view-data';
                        }, 2000);
                    } else {
