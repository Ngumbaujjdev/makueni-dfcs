...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Update Bank Staff</h1>
                ...
                <?php
                   if (isset($_GET['id'])) {
                       $app = new App;
                       $id = $_GET['id'];
                       $query = "SELECT bs.*, b.name as bank_name, b.branch as bank_branch, u.email, u.first_name, u.last_name
                                 FROM bank_staff bs
                                ...
                                <div class="row gy-3">
                                    <div class="col-xl-12">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?php echo $staff->bank_name . ' - ' . $staff->bank_branch ?>"
                                            readonly>
                                    </div>
                                    <div class="col-xl-6">
    ...
    function updateBankStaff() {
        ...
        if (!$('#first-name').val() || !$('#last-name').val() || !$('#email').val() ||
            !$('#position').val() || !$('#staff-number').val() || !$('#department').val()) {
