...
<body>
    ...
    function displayActiveLoans() {
        ...
        $.ajax({
            url: "http://localhost/dfcs/ajax/loan-controller/display-farmer-bank-active-loans.php",
            type: 'POST',
            data: {
    ...
    function viewLoanDetails(loanId) {
        ...
        window.location.href = "http://localhost/dfcs/farmers/bank-loans/view-loan-details?id=" + loanId;
    }

    function viewRepayments(loanId) {
        // Redirect to loan repayments page
        window.location.href = "http://localhost/dfcs/farmers/bank-loans/view-repayments?id=" + loanId;
    }
