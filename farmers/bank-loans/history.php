...
<body>
    ...
    <div class="page">
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <!-- Row 1: Bank Loan Performance Summary -->
                <div class="row mt-2">
                    <div class="col-12">
                        <h6 class="mb-3 text-dark"><i class="fa-solid fa-chart-line text-success me-2"></i>Bank Loan
                            Performance Summary</h6>
                    </div>

                    <!-- Total Bank Loans Ever Requested -->
                                ...
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-white mb-0">Total Bank Loans</p>
                                                <h4 style="color:wheat;" class="fw-semibold mt-1">
                                                    <?php 
                                                       // Get total number of bank loans ever requested
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Bank Approval Rate</p>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php 
                                                    // Calculate bank loan approval rate
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Average Bank Loan</p>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php 
                                                    // Calculate average approved bank loan amount
                    ...
                    <!-- Total Bank Loans Borrowed Historically -->
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Total Bank Borrowing
                                                </p>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php 
                                                    // Calculate total amount borrowed from banks historically
                                            ...
                                            <div class="text-center position-relative" style="width: 100px;">
                                                <?php 
                                                        ...
                                                        $completedLoansQuery = "SELECT 
                                                                              ...
                                                                              FROM approved_loans al
                                                                              JOIN loan_applications la ON al.loan_application_id = la.id
                                                                              WHERE la.farmer_id = {$farmer_id} AND la.provider_type = 'bank' AND la.status IN ('approved', 'completed', 'defaulted')";
                                                            ...
                                                            <h6 class="mb-0 fw-semibold">
                                                                <?php 
                                                                 ...
                                                                 $interestPaidQuery = "SELECT 
                                                                                     ...
                                                                                     FROM approved_loans al
                                                                                     JOIN loan_applications la ON al.loan_application_id = la.id
                                                                                     WHERE la.farmer_id = {$farmer_id} AND la.provider_type = 'bank' AND al.status = 'completed'";
    ...
    function displayLoanHistory() {
        ...
        $.ajax({
            url: "http://localhost/dfcs/ajax/loan-controller/display-farmer-bank-loan-history.php",
            type: 'POST',
            data: {
    ...
    function viewLoanDetails(loanId) {
        ...
        window.location.href = "http://localhost/dfcs/farmers/bank-loans/view-details?id=" + loanId;
    }
    ...
    function applyForLoan() {
        ...
        window.location.href = "http://localhost/dfcs/farmers/bank-loans/apply";
    }
    </script>
</body>
