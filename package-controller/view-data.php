...
<body>
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div>
                        ...
                        <?php else: ?>
                            ...
                            <?php endforeach; ?>
                        <?php endif; ?>
                        <span class="fs-semibold text-muted pt-5">View All Your Packages</span>
                                ...
                                <div class="d-flex align-items-top justify-content-between">
                                    <div>
                                        <span class="avatar avatar-md avatar-rounded"
                                            ...
                                            <i style="color:#6AA32D" class="fa-solid fa-box-archive fs-16"></i>
                                        </span>
                                    </div>
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-white mb-0">Total Packages</p>
                                                <?php
                                                $app = new App;
                                                $query = "SELECT * FROM tour_packages";
                                                $package_count = $app->count($query);
                                                ?>
                                                <h4 style="color:wheat;" class="fw-semibold mt-1">
                                                    <?php echo $package_count ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Active Packages</p>
                                                <?php
                                                $query = "SELECT * FROM tour_packages WHERE status='active'";
                                                $active_packages = $app->count($query);
                                                ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php echo $active_packages ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-top justify-content-between">
                                    <div>
                                        <span class="avatar avatar-md avatar-rounded" style="background: white;">
                                            <i style="color:#6AA32D" class="fa-solid fa-file-lines f-16"></i>
                                        </span>
                                    </div>
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="mb-0" style="color:white">Draft Packages</p>
                                                <?php
                                                $query = "SELECT * FROM tour_packages WHERE status='draft'";
                        ...
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    <div>
                                        <span class="avatar avatar-md avatar-rounded" style="background:#6AA32D;">
                                            <i class="fa-solid fa-dollar-sign fs-16"></i>
                                        </span>
                                    </div>
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Avg. Package Price</p>
                                                <?php
                                                $query = "SELECT AVG(display_price) as avg_price FROM tour_packages WHERE status='active'";
                                                $result = $app->select_one($query);
                                                $avg_price = isset($result->avg_price) ? number_format($result->avg_price, 2) : 0;
                                                ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    KSH <?php echo $avg_price ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function displayPackages() {
            let displayPackages = "true";
            $.ajax({
                url: "../ajax/package-controller/display-packages.php",
                type: 'POST',
                data: {
        ...
        function deletePackage(deleteid) {
            $.ajax({
                url: "../ajax/package-controller/delete-package.php",
                type: "POST",
                data: {
                    deletesend: deleteid
                },
        ...
        function changePackageStatus(id, status) {
            $.ajax({
                url: "../ajax/package-controller/change-status.php",
                type: "POST",
                data: {
                    id: id,
                    status: status,
