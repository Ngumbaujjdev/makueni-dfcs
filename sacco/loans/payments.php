...
<body>
    ...
    <div class="page">
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <!-- SACCO Repayment Stats Cards -->
                <div class="row mt-2">
                    <!-- Total SACCO Repayments -->
                                ...
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-white mb-0">Total SACCO Repayments</p>
                                                <?php
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">SACCO Amount Repaid
                                                </p>
                                                <?php
                    ...
                    <!-- Current Month SACCO Repayments -->
                    <div class="col-xxl-3 col-lg-3 col-md-6">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">SACCO Repaid This
                                                    Month</p>
                                                <?php
                ...
                <!-- Dynamic Repayment Details Card - Add this after your table -->
                <div id="repaymentDetailsCard" class="card mt-4" style="display: none;">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">
                            <i class="ri-file-info-line me-2"></i>Repayment Details
                        </h5>
                        <button type="button" class="btn btn-sm btn-outline-secondary" onclick="hideRepaymentDetails()">
                            <i class="ri-close-line"></i> Hide
                        </button>
                    </div>
                    <div class="card-body">
                        <div id="repaymentDetailsContent">
                            <!-- Content will be loaded here via AJAX -->
                            <div class="text-center py-4">
                                <div class="spinner-border text-primary" role="status">
                                    <span class="visually-hidden">Loading...</span>
                                </div>
                                <p class="mt-2 text-muted">Loading repayment details...</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="d-flex justify-content-end gap-2">
                            <button type="button" class="btn btn-outline-secondary" onclick="hideRepaymentDetails()">
                                <i class="ri-close-line me-1"></i>Close
                            </button>
                            <button type="button" class="btn btn-primary" id="dynamicPrintReceipt">
    ...
    // Function to view repayment details
    function viewRepaymentDetails(repaymentId) {
        // Add debugging
        console.log('viewRepaymentDetails called with ID:', repaymentId);
        console.log('Type of repaymentId:', typeof repaymentId);

        // Validate repaymentId
        if (!repaymentId || repaymentId === undefined || repaymentId === null) {
            toastr.error('Invalid repayment ID', 'Error', {
                "positionClass": "toast-top-right",
                "progressBar": true,
                "timeOut": 5000
            });
        ...
        $.ajax({
            url: "http://localhost/dfcs/ajax/loan-controller/get-repayment-details.php",
            type: "POST",
            data: {
            ...
            success: function(response) {
                ...
                $('#repaymentDetailsContainer').html(response);
            },
            error: function(xhr, status, error) {
