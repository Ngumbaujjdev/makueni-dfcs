...
<body>
    ...
    <div class="page">
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <!-- Page Header -->
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Active Loans</h1>
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="#">Loans</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Loans Active</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                                ...
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-white mb-0">Pending SACCO Applications</p>
                                                <?php
                                        $query = "SELECT COUNT(*) as count FROM loan_applications WHERE status = 'under_review' AND provider_type = 'sacco'";
                                        $result = $app->select_one($query);
                                        $pending_sacco_loans = ($result) ? $result->count : 0; 
                                      ?>
                                                <h4 style="color:wheat;" class="fw-semibold mt-1">
                                                    <?php echo $pending_sacco_loans ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                ...
                                                <?php 
                                       $query = "SELECT COUNT(*) as count FROM loan_applications WHERE status = 'approved' AND provider_type = 'sacco'";
                                       $result = $app->select_one($query);
                                       $approved_sacco_loans = ($result) ? $result->count : 0;
                                     ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php echo $approved_sacco_loans ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Active SACCO Loans</p>
                                                <?php
                                      ...
                                      $result = $app->select_one($query); 
                                      $active_sacco_loans = ($result) ? $result->count : 0;
                                    ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    <?php echo $active_sacco_loans ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#6AA32D;">Total SACCO Approved
                                                </p>
                                                <?php
                                       ...
                                       $result = $app->select_one($query);
                                       $total_sacco_approved = ($result) ? number_format($result->total_amount, 2) : 0;
                                     ?>
                                                <h4 class="fw-semibold mt-1" style="color:#6AA32D;">
                                                    KES <?php echo $total_sacco_approved ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- Total SACCO Amount Owed -->
                    <div class="col-xxl-4 col-lg-4 col-md-6">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    <div>
                                        <span class="avatar avatar-md avatar-rounded" style="background:#FF5733;">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#FF5733;">Total SACCO Amount
                                                    Owed</p>
                                                <?php
                                       $query = "SELECT COALESCE(SUM(al.remaining_balance), 0) as total_owed
                                                 FROM approved_loans al
                                                 JOIN loan_applications la ON al.loan_application_id = la.id  
                                                 WHERE al.status = 'active' AND la.provider_type = 'sacco'";
                                       $result = $app->select_one($query);
                                       $total_sacco_owed = ($result) ? number_format($result->total_owed, 2) : 0;
                                     ?>
                                                <h4 class="fw-semibold mt-1" style="color:#FF5733;">
                                                    KES <?php echo $total_sacco_owed ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- Total SACCO Amount Repaid -->
                    <div class="col-xxl-4 col-lg-4 col-md-6">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    <div>
                                        <span class="avatar avatar-md avatar-rounded" style="background:#00B74A;">
                                            <i class="fa-solid fa-sack-dollar fs-16"></i>
                                        </span>
                                    </div>
                                    <div class="flex-fill ms-3">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <p class="text-muted mb-0" style="color:#00B74A;">Total SACCO Amount
                                                    Repaid
                                                </p>
                                                <?php  
                                      $query = "SELECT COALESCE(SUM(al.approved_amount - al.remaining_balance), 0) as total_repaid
                                                FROM approved_loans al
                                                JOIN loan_applications la ON al.loan_application_id = la.id
                                                WHERE al.status IN ('active', 'completed') AND la.provider_type = 'sacco'";
                                      $result = $app->select_one($query);
                                      $total_sacco_repaid = ($result) ? number_format($result->total_repaid, 2) : 0; 
                                    ?>
                                                <h4 class="fw-semibold mt-1" style="color:#00B74A;">
                                                    KES <?php echo $total_sacco_repaid ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row mt-4">
                <div class="col-xl-12">
                    <div id="activeLoanApplicationsSection"></div>
                </div>
            </div>
    ...
    function displayActiveLoans() {
        ...
        $.ajax({
            url: "http://localhost/dfcs/ajax/loan-controller/display-active-loans.php",
            type: 'POST',
            data: {
                displayActiveLoans: displayActiveLoans,
            },
            success: function(data, status) {
                $('#activeLoanApplicationsSection').html(data);
            },
        });
    }
    // Function to view loan details (redirects to details page)
    function viewLoanDetails(loanApplicationId) {
        window.location.href = "loan-details?id=" + loanApplicationId;
    }
    </script>
