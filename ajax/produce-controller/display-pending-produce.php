...
if (isset($_POST['displayPendingProduce'])):
    $app = new App;
...
<div class="card custom-card">
    <div class="card-header justify-content-between">
        <div class="card-title">
            Pending Produce Deliveries
        </div>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="datatable-produce" class="table table-bordered text-nowrap w-100">
                <thead>
                    <tr>
                        <th>Reference</th>
                        <th>Farmer</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <button class="btn btn-sm btn-success" title="Verify Produce"
                                    onclick="verifyProduce(<?php echo $produce->id ?>)">
                                    <i class="ri-check-line"></i> Verify
                                </button>
                                <button class="btn btn-sm btn-danger" title="Reject Produce"
                                    onclick="rejectProduce(<?php echo $produce->id ?>)">
                    ...
                    <?php else: ?>
                    <tr>
                        <td colspan="10" class="text-center">No pending produce deliveries found</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
