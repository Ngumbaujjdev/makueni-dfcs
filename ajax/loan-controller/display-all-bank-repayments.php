...
if (isset($_POST['displayAllRepayments'])):
    ...
    // Query to get all bank loan repayments with related data
    $query = "SELECT 
                lr.id,
                lr.approved_loan_id,
                ...
                <table id="datatable-repayments" class="table table-bordered text-nowrap w-100">
                    <thead>
                        <tr>
                            ...
                            <th><i class="ri-credit-card-line me-1"></i>Method</th>
                    ...
                    <tbody>
                        ...
                        <tr data-repayment-id="<?php echo $repayment->id ?>">
                            ...
                            <td>
                                <span class="badge bg-info-transparent text-info">
                                    ...
                                    <?php echo htmlspecialchars($repayment->bank_name ?: 'N/A') ?>
                                </span>
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button class="btn btn-sm btn-primary view-details-btn" title="View Details"
                                        ...
                                        data-bank-name="<?php echo htmlspecialchars($repayment->bank_name ?: 'N/A') ?>"
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-4">
                                ...
                                <p>No bank loan repayments found</p>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
...
$(document).ready(function() {
    ...
    var table = $('#datatable-repayments').DataTable({
        responsive: true,
        order: [
            [5, 'desc'] // Sort by date column (adjusted for bank column)
        ],
        language: {
    ...
    $(document).on('click', '.view-details-btn', function(e) {
        ...
        // Build the beautiful details HTML for bank repayments
        var detailsHtml = `
                    ...
                    <div class="card border-0 shadow-sm m-3">
                        <div class="card-header bg-gradient text-white" style="background: linear-gradient(135deg, #007bff 0%, #0056b3 100%);">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">
                                    <i class="ri-bank-line me-2"></i>
                                    Bank Loan Repayment Details - REP${String(repaymentId).padStart(5, '0')}
                                </h6>
                        ...
                        <div class="card-body">
                            <div class="row g-4">
                                    ...
                                    <div class="border rounded p-3 h-100" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <p class="mb-0">
                                                    <span class="badge bg-info-transparent text-info">
                                                        <i class="ri-credit-card-line me-1"></i>${paymentMethod}
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="border rounded p-3 h-100" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
                                        <h6 class="text-success mb-3">
                                            <i class="ri-user-line me-2"></i>Farmer & Bank Details
                                        </h6>
                                        <div class="row g-3">
                                            <div class="col-12">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <p class="mb-0">
                                                    <span class="badge bg-info-transparent text-info">
                                                        <i class="ri-bank-line me-1"></i>${bankName}
                                                    </span>
                                                </p>
                                            </div>
                                            <div class="col-12">
                                ...
                                <!-- Notes Section -->
                                <div class="col-12">
                                    <div class="border rounded p-3" style="background: linear-gradient(135deg, #fff3cd 0%, #ffeaa7 100%);">
                                ...
                                <!-- Bank Loan Summary -->
                                <div class="col-12">
                                    <div class="alert alert-info" style="background: linear-gradient(135deg, #d1ecf1 0%, #bee5eb 100%); border: none;">
                                        <h6 class="alert-heading mb-2">
                                            <i class="ri-information-line me-1"></i>
                                            Bank Loan Repayment Summary
                                        </h6>
                                        <p class="mb-0">
                                            <strong>${farmerName}</strong> made a payment of 
                                            <strong>KES ${amount}</strong> on <strong>${paymentDate}</strong>
                                            to <strong>${bankName}</strong> via ${paymentMethod.toLowerCase()}.
                                        </p>
                                    </div>
                                </div>
        ...
        toastr.success('Bank repayment details loaded', 'Success', {
...
function printRepaymentReceipt(repaymentId) {
    console.log('Print receipt for bank repayment:', repaymentId);
    ...
    setTimeout(function() {
        toastr.success('Bank receipt would be downloaded here', 'Success', {
            "positionClass": "toast-top-right",
            "progressBar": true,
            "timeOut": 3000
        });
